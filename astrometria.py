...
datos_calibrados = open('Sharks_sgp_e_2_cat_small.fits', 'w')

#print (mag1Finalajuste1)

#df['MAG_AUTO']= mag1Finalajuste1


for i in range(len(mag1Finalajuste1)):
    
    mag1[i]= str(mag1[i]).replace(str(mag1[i]), str(mag1Finalajuste1[i]))
    
    
  


datos_calibrados.close()
